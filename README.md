...
In the Lambda service, I went to the 'Code' tab and added the code from the repository (image-scaler-code.py). I changed the name of the destination bucket to my own. Then, I clicked 'Deploy'.
